...
for thisfile,exp_type,nodename,postproc,f_range,t_range,clock_correction,IR,ILT in [
       ('210628_50uM_TEMPO_hexane_cap_probe_DNP','inv_rec',
           'FIR_34dBm','spincore_IR_v1',
           (-0.126e3,0.34e3),(None,45e-3),True,False,False),
    ...
    T1 = process_IR(s,label=thisfile,W=8,f_range=f_range,t_range=t_range,
            clock_correction=clock_correction,IR=IR,flip=False,sgn=mysgn,fl=fl) 
    fl.show()
