...
# {{{ Enhancement
    ...
    if save_figs:
        plt.savefig('%s_enhancement.png'%outname,transparent=True,overwrite=True,bbox_inches='tight')
#    plt.show()
#    plt.close()
# }}}
# {{{ Determining ksigma*s(p) or any other possible corrections...
    ...
    # }
        ...
        if save_figs:
            plt.savefig('%s_ksigma.png'%outname,transparent=True,overwrite=True,bbox_inches='tight')
#        plt.show()
#        plt.close()
# }}}
#}
