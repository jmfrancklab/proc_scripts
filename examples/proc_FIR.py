...
plot_fit = True
# I'm using the color cycle for more plots than just those made by rough_table_of_integrals, see 
...
with psd.figlist_var() as fl:
    ...
    for nodename in [
        ...
        if plot_fit: # JF has not reviewed this -- needs to be re-written
            ...
            ax = plt.gca()
# I'm not printing anything for 'T1 = ?' as desired in the list of goals, what should I be printing? T1 at s.max()?
