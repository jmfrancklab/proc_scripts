# -*- coding: utf-8 -*-
#
# pySpecData documentation build configuration file, created by
...
sys.path.append(os.path.abspath("../../pyspecdata"))
...
author = (
    "Alexandria Guinness, Alec A. Beaton, Samantha M. Betts, John M. Franck"
)
...
html_css_files = ["gallery_custom.css", "custom.css"]
...
htmlhelp_basename = "pySpecDatadoc"
...
man_pages = [
    (master_doc, "pyspecdata", "pySpecData Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "pySpecData",
        "Object-Oriented N-Dimensional Data Processing",
        "Miscellaneous",
    ),
]
