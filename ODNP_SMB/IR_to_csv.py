...
powers = np.r_[0,2,2.5,3.16,3.98] #W -> [0,33,34,35,36] dBm
exp_type = 'odnp'
postproc = 'spincore_IR_v1'
export_csv = True
csv_path = 'C:/Users/saman/proc_scripts/ODNP_SMB'
single_file = False
if single_file:
    export_csv = False
if export_csv:
...
# {210707_Q183R1a_pR_DDM_ODNP
    (0,filename,'FIR_noPower_real_newvd2',(-200,25),(None,60e-3),3,False,False,False),
